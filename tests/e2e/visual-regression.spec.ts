...
test.describe('Visual Regression Tests', () => {
  ...
  test('logo wall section screenshot', async ({ page }) => {
    ...
    await page.locator('text=Trusted by leading cooperators').scrollIntoViewIfNeeded();
  ...
  test('numbered cards section screenshot', async ({ page }) => {
    ...
    await page.locator('h2:has-text("How CommunityRule works")').scrollIntoViewIfNeeded();
    await page.waitForTimeout(500);
  ...
  test('feature grid section screenshot', async ({ page }) => {
    ...
    await page.locator('h2:has-text("We\'ve got your back")').scrollIntoViewIfNeeded();
    await page.waitForTimeout(500);
